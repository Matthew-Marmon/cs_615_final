...
TERMINATE_EPOCH = 2500
DIMENSIONALITY = [22, 48, 24, 12, 3, 1]
DROPOUT_PROBABILITY = 0.4 #change this .4
LAYERS_PER_BLOCK = 2 # this should be good 
BLOCKS_PER_STAGE = 5 # this 5-6 next
BATCH_SIZE = 128 #128 next
SUBSET_SIZE = 5000
